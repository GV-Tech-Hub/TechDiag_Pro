...
Copyright (C) 2010-2020 PassMark Software
All Rights Reserved
...
Requirements
============
- Operating System: Vista, Windows 7, 8, 10
- RAM: 256 Meg 
...
-Updated Max Drives from 50 to 128 (experimental, not tested)

Release 1.5.1004 (Internal)
WIN32 release 5 May 2021
-Changed program font to fix display issue on foreign language OS.
-Updated platform toolset to VS2019
